...
#                     images, labels_onehot = train_transforms(
#                         images,
#                         labels_onehot,
#                     )
#                 optimizer.zero_grad()
...
#                   Time: {mins}m {secs}s Train Loss: {avg_train_loss:.4f} |
#                   Val Loss: {avg_val_loss:.4f} | Val Precision: {
#                     prec_val * 100:.2f
#                 }% | Val Accuracy: {acc_val * 100:.2f}% |
#                      Val Recall: {rec_val * 100:.2f}% |
#                      Val F1: {f1_val * 100:.2f}%",
#             )
...
#     if live_count > 0:
#         results.append(
#             {"Spoof Type": "Live", "Type ID": 0, "Count": live_count},
#         )
