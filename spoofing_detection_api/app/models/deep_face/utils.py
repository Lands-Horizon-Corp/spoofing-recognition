...
class DeepFace:
    def __init__(self, model_name):
        ...
        self.model, self.input_name, self.output_name = cast(
            tuple, self.load_model())
    ...
    def load_model(self):
        ...
        try:
            ...
            return ValueError(f"error loading model - {self.model_name}: {e}")
...
class FaceAnalysis:
    ...
    def postprocess(self, output):
        if self.model_name == 'emotion':
            ...
            labels = ['asian', 'indian', 'black', 'white',
